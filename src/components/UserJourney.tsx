...
const UserJourney = () => {
  ...
  const journeySteps = [
    { 
      ...
      description: "Мы погружаемся в суть вашего бизнеса, анализируем рыночные тренды и разрабатываем индивидуальную стратегию цифрового развития.",
      icon: <Lightbulb size={22} />,
      delay: 0.1
    },
    { 
      title: "Креативное прототипирование", 
      description: "Создаем интерактивные прототипы с фокусом на пользовательский опыт, конверсию и эстетическую привлекательность интерфейса.",
      icon: <Settings size={22} />,
      delay: 0.2
    },
    { 
      title: "Профессиональная разработка", 
      description: "Применяем современные технологии и методологии для создания высокопроизводительных, масштабируемых и защищенных цифровых решений.",
      icon: <Code size={22} />,
      delay: 0.3
    },
    { 
      title: "Запуск и оптимизация", 
      description: "Обеспечиваем плавный запуск проекта, проводим комплексное тестирование и настраиваем аналитические инструменты для мониторинга эффективности.",
      icon: <Rocket size={22} />,
      delay: 0.4
    },
    { 
      title: "Комплексное сопровождение", 
      description: "Предоставляем техническую поддержку 24/7, регулярные обновления и консультации по дальнейшему развитию вашего цифрового присутствия.",
      icon: <CheckCircle size={22} />,
      delay: 0.5
    },
    { 
      title: "Масштабирование бизнеса", 
      description: "Помогаем адаптировать ваше цифровое решение к растущим потребностям бизнеса и увеличению нагрузки на системы.",
      icon: <Clock size={22} />,
      delay: 0.6
    },
    { 
      title: "Инновационное развитие", 
      description: "Внедряем передовые технологии — искусственный интеллект, машинное обучение и предиктивную аналитику для обеспечения конкурентного преимущества.",
      icon: <Star size={22} />,
      delay: 0.7
    }
  ];
